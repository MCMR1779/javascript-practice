...
def reactor_efficiency(voltage, current, theoretical_max_power):
    ...
    percentage_of_efficiency = genrated_power/theoretical_max_power*100
    if percentage_of_efficiency >= 80:
        return 'green'
    elif 60 <= percentage_of_efficiency < 80:
        return 'orange'
    elif 30 <= percentage_of_efficiency < 60:
        return 'red'
    else:
        return 'black'
