...
def value_of_hand_card(card):
    if card == 'A':
        return 11
    return value_of_card(card)
    
def value_of_ace(card_one, card_two):
    val_one = value_of_hand_card(card_one)
    val_two = value_of_hand_card(card_two)
    remaining_value = 21 - val_one - val_two
    if remaining_value < 11 or card_one == 'A' or card_two == 'A':
        return 1
    else:
        return 11
...
def is_blackjack(card_one, card_two):
    val_one = value_of_hand_card(card_one)
    val_two = value_of_hand_card(card_two)
    if (card_one == 'A' or card_two == 'A') and (val_one == 10 or val_two == 10):
        return True
    else :
        return False
